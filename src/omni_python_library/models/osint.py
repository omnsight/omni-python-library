...
class RelationMainData(BaseModel):
    name: Optional[str] = Field(
        default=None, max_length=100, description="Name of the relation used in database key (must be ascii letters)"
    )
    confidence: Optional[int] = Field(default=None, ge=0, le=100, description="Confidence score")
    label: Optional[str] = Field(
        default=None, max_length=100, description="Label name of the relation (can be any language) to display"
    )
    attributes: Optional[Dict[str, Any]] = Field(default=None, max_length=50, description="Additional attributes")

    # Edges specific fields
    from_id: Optional[str] = Field(default=None, alias="_from", max_length=100, description="Source document ID")
    to_id: Optional[str] = Field(default=None, alias="_to", max_length=100, description="Target document ID")
...
class EventMainData(BaseModel):
    ...
    happened_at: Optional[int] = Field(default=None, ge=0, description="Timestamp when the event happened")
...
class SourceMainData(BaseModel):
    ...
    reliability: Optional[int] = Field(default=None, ge=0, le=100, description="Reliability score")
    tags: Optional[List[str]] = Field(default=None, max_length=100, description="Tags")
    attributes: Optional[Dict[str, Any]] = Field(default=None, max_length=50, description="Additional attributes")
...
class PersonMainData(BaseModel):
    type: Optional[str] = Field(default=None, max_length=100, description="Role type of person")
    ...
    nationality: Optional[str] = Field(default=None, max_length=100, description="Nationality")
    birth_date: Optional[int] = Field(default=None, ge=0, description="Person's birth date (timestamp)")
    tags: Optional[List[str]] = Field(default=None, max_length=100, description="Tags")
    aliases: Optional[List[str]] = Field(default=None, max_length=100, description="Aliases")
    attributes: Optional[Dict[str, Any]] = Field(default=None, max_length=50, description="Additional attributes")
...
class OrganizationMainData(BaseModel):
    type: Optional[str] = Field(default=None, max_length=100, description="Type of organization")
    name: Optional[str] = Field(default=None, max_length=100, description="Name of the organization")
    founded_at: Optional[int] = Field(default=None, ge=0, description="When organization is founded (timestamp)")
    discovered_at: Optional[int] = Field(default=None, ge=0, description="When organization is discovered (timestamp)")
    last_visited: Optional[int] = Field(default=None, ge=0, description="When organization is last visited (timestamp)")
    tags: Optional[List[str]] = Field(default=None, max_length=100, description="Tags")
    attributes: Optional[Dict[str, Any]] = Field(default=None, max_length=50, description="Additional attributes")
...
class WebsiteMainData(BaseModel):
    ...
    founded_at: Optional[int] = Field(default=None, ge=0, description="When website is founded (timestamp)")
    discovered_at: Optional[int] = Field(default=None, ge=0, description="When website is discovered (timestamp)")
    last_visited: Optional[int] = Field(default=None, ge=0, description="When website is last visited (timestamp)")
    tags: Optional[List[str]] = Field(default=None, max_length=100, description="Tags")
    attributes: Optional[Dict[str, Any]] = Field(default=None, max_length=50, description="Additional attributes")
