...
class TestViewCRUD(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            ArangoDBClient().init(
                host="http://localhost:8529", username="root", password="", db_name="test_osint_db_view"
            )
        except Exception as e:
    ...
    def test_view_lifecycle(self):
        ...
        updated_view = self.dal.update_view(view.id, OsintViewMainData(description="Updated Description"))
        ...
        self.dal.connect_entity_to_view(view.id, person.id)
